        ...
        <div class="p-4 mt-14">
            ...
            <div class="p-5 h-fit mb-4 rounded bg-gray-50 dark:bg-gray-800 space-y-10">
                <div class="flex justify-between items-center">
                    <div><h1 class="font-bold">Create Driver</h1></div>
                    <nav class="flex" aria-label="Breadcrumb">
                        ...
                        <li>
                            ...
                            <a href="{{ route('list.driver') }}" wire:navigate class="ml-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ml-2 dark:text-gray-400 dark:hover:text-white">List Driver</a>
                            </div>
                        </li>
                ...
                <div class=" sm:rounded-lg space-y-5">
                    ...
                    <div>
                        <label for="message" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Deskripsi/Catatan</label>
                        <textarea wire:model='form.desc' id="message" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            placeholder="Masukkan Deskripsi/Catatan"></textarea>
                        @error('form.desc')
                            <p class="mt-2 text-sm text-red-600 dark:text-red-500">{{ $message }}</p>
                        @enderror
                    </div>
